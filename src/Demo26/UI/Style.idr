...
namespace Color
  ...
  public export
  FinInt : Int -> Type
  FinInt n = (x : Int ** x < n = True)

  export
  Show (FinInt 256) where
    show (x ** _) = show x
  ...
  export
  fromInteger : (x : Integer) -> {auto lt : the Int (cast x) < 256 = True} -> FinInt 256
  fromInteger x {lt} = (cast x ** lt)

  export
  data Color : Type where
    RGBA : FinInt 256 -> FinInt 256 -> FinInt 256 -> Double -> Color
  ...
  export
  rgb : (red : FinInt 256) -> (green : FinInt 256) -> (blue : FinInt 256) -> Color
  rgb red green blue = RGBA red green blue 1

  export
  rgba : (red : FinInt 256) -> (green : FinInt 256) -> (blue : FinInt 256) -> (alpha : Double) -> Color
  rgba = RGBA
  ...
  export
  toRGBA : Color -> (FinInt 256, FinInt 256, FinInt 256, Double)
